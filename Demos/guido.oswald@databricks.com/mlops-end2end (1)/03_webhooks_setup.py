...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=984752964297111&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F03_webhooks_setup&uid=6066264009754637">
...
reset_webhooks(model_name = "guido_churn_model")
...
create_job_webhook(model_name = "guido_churn_model", job_id = job_id)

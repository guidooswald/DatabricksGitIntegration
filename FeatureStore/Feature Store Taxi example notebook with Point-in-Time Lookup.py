...
# MAGIC %sql CREATE DATABASE IF NOT EXISTS guido_feature_store_taxi_example;
...
fs.create_table(
    name="guido_feature_store_taxi_example.trip_pickup_time_series_features",
    primary_keys=["zip"],
    timestamp_keys=["ts"],
    df=pickup_features,
...
fs.create_table(
    name="guido_feature_store_taxi_example.trip_dropoff_time_series_features",
    primary_keys=["zip"],
    timestamp_keys=["ts"],
    df=dropoff_features,
...
# MAGIC FROM
# MAGIC   guido_feature_store_taxi_example.trip_dropoff_time_series_features
# MAGIC WHERE
